        ...
        <table className="w-full min-w-[640px]">
          <thead>
            <tr className="border-b border-gray-200">
              <th className="text-left py-3 px-2 text-xs md:text-sm font-semibold text-gray-700 w-16">
                Sr No
              </th>
              <th className="text-left py-3 px-2 text-xs md:text-sm font-semibold text-gray-700">
                Description
              </th>
              <th className="text-right py-3 px-2 text-xs md:text-sm font-semibold text-gray-700 w-28">
                Rate
              </th>
              <th className="text-right py-3 px-2 text-xs md:text-sm font-semibold text-gray-700 w-24">
                Quantity
              </th>
              <th className="text-right py-3 px-2 text-xs md:text-sm font-semibold text-gray-700 w-32">
                Amount
              </th>
